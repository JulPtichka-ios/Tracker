...
final class NewHabitViewController: UIViewController {
    ...
    private let emojiSectionView = EmojiSectionView()
    private let colorSectionView = ColorSectionView()
    ...
    override func viewDidLayoutSubviews() {
        ...
        let bottomInset = actionButtonsView.frame.height + 24
    ...
    private func setDefaultSelections() {
        ...
        colorSectionView.setSelectedColor(TrackerData.colors.first)
    }
    ...
    private func updateScheduleButtonTitle() {
        ...
        let attributedText = NSAttributedStringBuilder.buildScheduleText(
            ...
            primaryColor: UIColor(named: "ypBlack") ?? .black,
            secondaryFont: AppTextStyles.regular17,
            secondaryColor: UIColor(named: "ypGray") ?? .systemGray
        )
...
extension NewHabitViewController {
    ...
    private func createCategoryContainer() -> UIView {
        ...
        arrow.tintColor = UIColor(named: "ypGray") ?? .systemGray
...
extension NewHabitViewController {
    ...
    private func createTracker() {
        ...
        let colorName = TrackerData.getColorName(for: color) ?? "ColorSelection1"
